...
LABEL org.opencontainers.image.title=WPFranken
LABEL org.opencontainers.image.description="High performance WordPress containers Built with FrankenPHP & Caddy."
LABEL org.opencontainers.image.url=https://ilmu.website
LABEL org.opencontainers.image.source=https://github.com/bosdaring/wpfranken
...
RUN groupadd -g ${UID} ${USER} && useradd -u ${UID} -g ${USER} -m ${USER}; \
